...
set more 1;
set logtype text;
log using JOLEcluster-runs_table3, replace;
set matsize 450;
...
reg lnths mico _Iyear* _Istate* , cluster(state);
reg lnths mico _Iyear* _Istate* _IstaXt_* , cluster(state);

reg lnths mppa _Iyear* _Istate* , cluster(state);
reg lnths mppa _Iyear* _Istate* _IstaXt_* , cluster(state);

reg lnths mgfa _Iyear* _Istate* , cluster(state);
reg lnths mgfa _Iyear* _Istate* _IstaXt_* , cluster(state);

reg lnths mico mppa mgfa _Iyear* _Istate* , cluster(state);
reg lnths mico mppa mgfa _Iyear* _Istate* _IstaXt_* , cluster(state);
