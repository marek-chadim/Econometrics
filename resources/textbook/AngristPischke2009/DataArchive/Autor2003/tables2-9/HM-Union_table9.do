...
set more 1;
set logtype text;
log using HM-Union_table9, replace;
set matsize 450;
set mem 20m;
use eow-svcs.dta;
...
******************************************;
** Table 9: Other service employment
******************************************;

reg lnbiz lnemp hm_union mico mppa mgfa _Iyear* _Istat* _IstaXt_* [aw=empwt]if year>=79, cluster(state);
reg lnsvc lnemp hm_union mico mppa mgfa _Iyear* _Istat* _IstaXt_* [aw=empwt]if year>=79, cluster(state);
reg lnadv lnemp hm_union mico mppa mgfa _Iyear* _Istat* _IstaXt_* [aw=empwt]if year>=79, cluster(state);
reg lncrd lnemp hm_union mico mppa mgfa _Iyear* _Istat* _IstaXt_* [aw=empwt]if year>=79, cluster(state);
reg lnmal lnemp hm_union mico mppa mgfa _Iyear* _Istat* _IstaXt_* [aw=empwt]if year>=79, cluster(state);
reg lnbld lnemp hm_union mico mppa mgfa _Iyear* _Istat* _IstaXt_* [aw=empwt]if year>=79, cluster(state);
reg lneqp lnemp hm_union mico mppa mgfa _Iyear* _Istat* _IstaXt_* [aw=empwt]if year>=79, cluster(state);
reg lncmp lnemp hm_union mico mppa mgfa _Iyear* _Istat* _IstaXt_* [aw=empwt]if year>=79, cluster(state);
reg lnmsc lnemp hm_union mico mppa mgfa _Iyear* _Istat* _IstaXt_* [aw=empwt]if year>=79, cluster(state);
reg lnper lnemp hm_union mico mppa mgfa _Iyear* _Istat* _IstaXt_* [aw=empwt]if year>=79, cluster(state);
